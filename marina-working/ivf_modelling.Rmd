...
#Based on infertility + numbers + ovulation induction
  .metric  .estimator .estimate
  <chr>    <chr>          <dbl>
...
```{r}
# model 1
rf_multi <-  rand_forest(trees = 100, mode = "classification") %>%
  set_engine("randomForest") %>%
...
class_voting<-predict(rf_multi, my_testing, type = "prob") %>%
